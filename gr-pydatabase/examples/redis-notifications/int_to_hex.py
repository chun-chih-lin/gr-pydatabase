...
def main():
	int_list = np.array([8, 0, 0, 0, 66, 66, 66, 66, 66, 66, 35, 35, 35, 35, 35, 35, 255, 255, 255, 255, 255, 255, 144, 1, 155, 100, 102, 117, 104, 98, 101, 98, 114])
	header_json = parse_header(int_list)
	print(header_json)
