...
class USRP_RX_EXP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "USRP_RX_EXP")
        ...
        self._gain_nor_range = Range(0, 1, 0.01, 0.7, 200)
        ...
        self.uhd_usrp_source_0.set_normalized_gain(gain_nor, 0)
        ...
        self.pydatabase_redis_sink_exp_0 = pydatabase.redis_sink_exp('channel_1', 6379, 'localhost', 0, '00:00:00:00:00:00')
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.pydatabase_redis_sink_exp_0, 'pdu'))
    ...
    def set_gain_nor(self, gain_nor):
        ...
        self.uhd_usrp_source_0.set_normalized_gain(self.gain_nor, 0)
...
def main(top_block_cls=USRP_RX_EXP, options=None):
