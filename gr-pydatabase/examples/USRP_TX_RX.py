...
class USRP_TX_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "USRP_TX_RX")
        ...
        self.ieee802_11_mac_0 = ieee802_11.mac([0x8c, 0xec, 0x4b, 0xa7, 0x3e, 0x10], [0x8c, 0xec, 0x4b, 0xa7, 0x3c, 0x4f], [0x8c, 0xec, 0x4b, 0xa7, 0x3e, 0x10])
...
def main(top_block_cls=USRP_TX_RX, options=None):
