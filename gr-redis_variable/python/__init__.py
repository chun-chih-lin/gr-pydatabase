...
'''
This is the GNU Radio REDIS_VARIABLE module. Place your Python package
...
# import swig generated symbols into the redis_variable namespace
try:
    # this might fail if the module is python-only
    from .redis_variable_swig import *
